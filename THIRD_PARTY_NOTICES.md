...
|---|---|---|---|
| [Python](https://www.python.org/) | Runtime | Used for source installs; bundled in a packaged app when one is built | [PSF License Agreement](https://docs.python.org/3/license.html) |
